...
public class Auton2 extends OpMode {
    ...
    private final Pose scorePose = new Pose(56, 14, Math.toRadians(115)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    private final Pose leavePose = new Pose (64, 30, Math.toRadians(90));
