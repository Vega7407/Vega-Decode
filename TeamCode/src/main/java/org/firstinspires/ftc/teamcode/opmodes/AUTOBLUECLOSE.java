...
public class AUTOBLUECLOSE extends OpMode {
    ...
    private final Pose startPose = new Pose(21, 123, Math.toRadians(140)); // Start Pose of our robot.
    private final Pose scorePose = new Pose(53.5, 90, Math.toRadians(140)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    ...
    private PathChain grabPickup1, scorePickup1, grabPickup2, scorePickup2, grabPickup3, scorePickup3, leave;
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            */
                ...
                if(!follower.isBusy()) {
                    /* Score Preload */
                    outtakeMotor.setVelocity(1680);

                    /* Since this is a pathChain, we can have Pedro hold the end point while we are grabbing the sample */
                    if (outtakeMotor.getVelocity() > 1650) {
